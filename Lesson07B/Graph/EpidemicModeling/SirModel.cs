...
namespace Lesson07B.Graph.EpidemicModeling
{
    public class SirModel
    {
        ...
        public void Simulate(Graph graph, double beta, int mu, int iterations)
        {
            ...
            {
                models.Where(e => e.State == SirState.Infected).ForEach(e => e.InfectedDuration++);
                models.Where(e => e.State == SirState.Infected && e.InfectedDuration >= mu)
                    .ForEach(e =>
                    {
                ...
                models.Where(e => e.State == SirState.Susceptible)
                    .ForEach(e =>
                    {
